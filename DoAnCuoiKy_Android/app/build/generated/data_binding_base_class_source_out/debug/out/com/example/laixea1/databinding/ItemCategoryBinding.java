...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayout rootView, @NonNull TextView categoryDescription,
      @NonNull ImageView categoryIcon, @NonNull ProgressBar categoryProgress,
      @NonNull TextView categoryTitle, @NonNull TextView progressText) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((LinearLayout) rootView, categoryDescription, categoryIcon,
          categoryProgress, categoryTitle, progressText);
    }
