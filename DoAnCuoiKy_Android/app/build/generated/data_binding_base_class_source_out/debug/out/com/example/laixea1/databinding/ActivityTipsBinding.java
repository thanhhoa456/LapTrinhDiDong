...
public final class ActivityTipsBinding implements ViewBinding {
  ...
  private ActivityTipsBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView tipsRecyclerView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityTipsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTipsBinding((LinearLayout) rootView, tipsRecyclerView, toolbar);
    }
